...
from src.AI_model.SlayTheSpireRL.util.tokenizers import screen_type_tokenizer

from src.AI_model.SlayTheSpireRL.observations.player_observations import get_player_observation
from src.AI_model.SlayTheSpireRL.observations.hand_observations import get_hand_observation
from src.AI_model.SlayTheSpireRL.observations.monster_observations import get_monster_observation
from src.AI_model.SlayTheSpireRL.observations.map_observations import get_map_observation
from src.AI_model.SlayTheSpireRL.observations.potion_observations import get_potion_observation
from src.AI_model.SlayTheSpireRL.observations.relic_observations import get_relic_observation
from src.AI_model.SlayTheSpireRL.observations.extra_info_observations import get_extra_info_observation
from src.AI_model.SlayTheSpireRL.observations.deck_observations import get_deck_observation
from src.AI_model.SlayTheSpireRL.observations.screen_observations import get_screen_observation
...
class SlayTheSpireEnv(gym.Env):
    ...
    def get_invalid_action_mask(self, state):
        ...
        if not game_state:
            ...
            for i, action in enumerate(self.actions):
                if action not in ["START IRONCLAD 0"]:
                    invalid_action_mask[i] = True
